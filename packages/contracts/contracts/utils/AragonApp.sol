...
contract AragonApp is AppStorage, UUPSUpgradeable, ContextUpgradeable {
    ...
    function _update(uint oldVersion, bytes memory data) internal virtual;
    ...
    function update(uint oldVersion, bytes memory data) external virtual updateOnlyOnce onlyProxy {
